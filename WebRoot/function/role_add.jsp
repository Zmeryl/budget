...
function doAdd(){
	...
	document.all.frm.action = "roleAction!addRole.jhtml";
	document.all.frm.submit();
}
</script>
<script type="text/javascript">
parent.window.document.getElementById('msgDiv').innerHTML = "添加系统角色";
</script>
<title>添加功能</title>
</head>
...
<div class="tabcont">
	<form action="" method="post" name="frm">
		...
		<td><input type="text" class="input_01" name="sysRoleName" /></td>
		</tr>
		
		<tr class="white">
		<td>&nbsp;</td>
		<td class="align-r align-t">角色描述：</td>
		<td><input type="text" class="input_01" name="sysRoleDesc" /></td>
		</tr>
