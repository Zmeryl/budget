...
<script type="text/javascript">
parent.window.document.getElementById('msgDiv').innerHTML = "编辑系统角色";
</script>
<title>编辑功能</title>
</head>
...
<div class="tabcont">
	<form action="" method="post" name="frm">
		...
		<tr class="gray">
			...
			<td><input type="text" class="input_01" name="sysRoleName" value="${role.sysRoleName}" /></td>
		</tr>
		
		<tr class="white">
			<td>&nbsp;</td>
			<td class="align-r align-t">角色描述：</td>
			<td><input type="text" class="input_01" name="sysRoleDesc" value="${role.sysRoleDesc}" /></td>
		</tr>
