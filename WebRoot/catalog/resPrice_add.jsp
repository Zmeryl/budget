...
function doAdd(){
	...
	document.all.frm.action = "resPriceAction!addPriceRes.jhtml";
	document.all.frm.submit();
}

</script>
<script type="text/javascript">
parent.window.document.getElementById('msgDiv').innerHTML = "添加资源基价";
</script>
<title>添加资源基价</title>
</head>
...
<div class="tabcont">
	<form action="" method="post" name="frm">
		...
		<td><input type="text" class="input_01" name="resName" />
		</td>
		</tr>
		...
		<td><input type="text" class="input_01" name="resBrand" />
		</td>
		</tr>
		...
		<td><input type="text" class="input_01" name="provider" />
		</td>
		</tr>
		...
		<td><input type="text" class="input_02" name="resUnit" />
		</td>
		</tr>
