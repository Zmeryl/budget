...
function doEdit(){
	...
	document.all.frm.action = "detailFactAction!updateDetailFact.jhtml";
...
function checkfrm(){
	...
	if(document.all.frm.alterDesc.value == ""){
		alert("请填写变更说明");
		return false;
	}
...
<script type="text/javascript">
parent.window.document.getElementById('msgDiv').innerHTML = "核实里程碑资源";
</script>
...
<div class="tabcont">
	<form action="" method="post" name="frm">
		...
		<tr class="gray">
		<td>&nbsp;</td>
		<td class="align-r align-t">实际情况说明：</td>
		<td><textarea class="textarea_01" name="alterDesc" >${detail.alterDesc }</textarea></td>
		</tr>
