...
function kindsSearch(){
	...
	document.all.frm.action = "showOtherAddJSP.jhtml";
...
<div class="tabcont">
		...
		<c:forEach items="${page.result}" var="priceOther" varStatus="priceResStatus" >
			<tr class="white">
				<td>
					<input type="radio" value="${priceOther.priceId}" name="priceId" value2="${priceOther.resName}" value3="${priceOther.price}" >
				</td>
				<td>${priceOther.cataName}&nbsp;</td>
    	...
    	<tr class="titletop">
    		<td>
        	<ambow:pagination actionName="showOtherAddJSP" 
