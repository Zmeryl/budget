...
function doAdd(){
	...
	document.all.frm.action = "deptRoleAction!addDepartmentRole.jhtml";
	document.all.frm.submit();
}
</script>
<script type="text/javascript">
parent.window.document.getElementById('msgDiv').innerHTML = "添加部门角色";
</script>
<title>添加角色</title>
</head>
...
<div class="tabcont">
		...
		<td><input type="text" class="input_01" name="deptRoleName" /></td>
		</tr>
		
		<tr class="gray">
		<td>&nbsp;</td>
		<td class="align-r">角色基价：</td>
		<td><input type="text" class="input_02" name="deptRolePrice" />
		元
		</td>
		</tr>
		...
		<td><textarea class="textarea_01" name="deptRoleInfo" ></textarea></td>
		</tr>
